...
//    });
    ...
    // если у нас единственный оператор - в том числе `return результат;`
    // `(аргументы) -> команда`   // (если оператор не `return`)
    // `(аргументы) -> результат` // (если оператор - `return`)
    // 4:
