...
public class Pizza {
  ...
  enum Size { // default - в рамках пакета, в том числе компаратору
    SMALL,
    MEDIUM,
    LARGE,
  }
...
//    }
  ...
  Size getSize() { // default - в рамках пакета, в том числе компаратору
    return size;
  }

  // is (а не get) для логических значений - "является таким-то"
